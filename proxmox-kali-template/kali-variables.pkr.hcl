...
variable "template_description" {
  ...
  type        = string
  default     = <<EOF
Kali Linux cloud image optimized for Cybersecurity and Penetration Testing.
Includes: Complete Kali tool suite, Metasploit, Burp Suite, Nmap, Wireshark, Aircrack-ng,
Hashcat, John the Ripper, SQLMap, and hundreds of security testing tools.
Ready for penetration testing, security auditing, digital forensics, and ethical hacking.
Built on Debian with rolling release security updates.
EOF
}
