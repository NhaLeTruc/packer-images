...
variable "template_description" {
  ...
  type        = string
  default     = <<EOF
Fedora Linux cloud image optimized for Data Engineering.
Includes: Apache Spark 3.5.0, Scala 2.13, Python 3 with PySpark, Hadoop 3.3.6,
Jupyter, Docker, Podman, and comprehensive data science libraries (pandas, numpy, scikit-learn).
Ready for PySpark and Scala Spark workloads with QEMU guest agent and cloud-init.
Cutting-edge packages with Red Hat innovation and stability.
EOF
}
